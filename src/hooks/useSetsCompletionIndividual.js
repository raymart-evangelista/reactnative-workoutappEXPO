...
const useSetsCompletionIndividual = (
  ...
  const [setsCompletionIndividual, setSetsCompletionIndividual] = useState(
    initialCompletionIndividual,
  );
